...
//simple project without integration we are not writing anything inside class

@RunWith(Cucumber.class)
@CucumberOptions(
        //giving which featureFile options
        features = "src/test/java/resources/featurefile",//content root from featurefile packeage
        glue = "au/com/carsguide", //path from project name-source root
